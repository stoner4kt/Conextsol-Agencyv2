        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 flex items-center justify-between shadow-lg">
          ...
          {isAdmin && !isAdding && !isEditing && (
            <button
              ...
              className="flex items-center space-x-1 px-3 py-2 bg-white hover:bg-neutral-200 text-black font-semibold text-xs rounded-lg transition-all cursor-pointer"
            >
              <Plus size={13} />
        ...
        {isAdding || isEditing ? (
          <form onSubmit={handleSaveSubmit} className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 md:p-6 shadow-xl space-y-4 animate-fadeIn">
            ...
            <div className="flex justify-end space-x-2 pt-2">
              ...
              <button
                type="submit"
                className="flex items-center space-x-1 px-5 py-2 bg-white hover:bg-neutral-200 text-black font-sans text-xs font-extrabold rounded-lg shadow-md cursor-pointer"
              >
                <Save size={13} />
